import { ForescatInformation, getDayName, getHourFormat, getIconoOpenWeather, getTemperature } from "./helper"
...
export const buildWeatherForecastWeeks = (list, currentTemperatureWeather) => {
    ...
    weekInfoList.forEach((item) => {
        ...
        <div class="bottom-info">${getTemperature(item.main.temp, currentTemperatureWeather)}</div>`
